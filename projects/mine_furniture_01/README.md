...
| `mine_structure:unicorn_elytra` | wearable glider | 커스텀 엘리트라(가슴 착용, 활공, 접힘/펴짐), 바닐라 elytra와 별개, in-game test 대기(실험) | `content/wearables/unicorn_costume.md` |
...
| `mine_structure:unicorn_transform_wand` | tool item | 변신 마법봉(동물 우클릭→랜덤 동물로 변신), in-game test 대기 | `content/items/unicorn_transform_wand.md` |
