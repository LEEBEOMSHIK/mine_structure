...
- 다음 작업 요약:
  ...
  33. ~~커스텀 날개를 나비 날개로 변경~~ — `unicorn_elytra`를 나비 날개로(둥근 forewing+hindwing, 그라데이션, 날개맥, eyespot 무늬, 해상도 32×64). `gen_custom_elytra.py` `butterfly_edge`/`draw_wing`/`spot`. Blockbench 확인. 검증 PASS (2026-06-08). 인게임 확인 필요
