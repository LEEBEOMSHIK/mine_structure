...
- 다음 작업 요약:
  ...
  16. ~~효과 음식 4종 / 마법 지팡이 / 건축 블록 3종 / 입는 코스튬 2종 추가~~ — FOOD_EFFECTS 맵, itemUse 지팡이, 데이터 주도형 커스텀 블록(terrain_texture), wearable+attachable 코스튬(플레이어 본 부착, 실험), 검증 PASS (2026-06-04). 인게임 검증 필요(특히 코스튬)
